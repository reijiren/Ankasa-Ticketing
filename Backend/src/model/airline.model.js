...
const airlineModel = {
    ...
    updateAirline: (id_airline, name) => {
        return new Promise((resolve, reject) => {
            db.query(`update airline set name='${name}' where id_airline=${id_airline}`, (err, res) => {
                if(err){
                    reject(err);
                }
                resolve(res);
    ...
    updateLogo: ({id_airline, logo}) => {
        return new Promise((resolve, reject) => {
            db.query(`update airline set logo='${logo}' where id_airline=${id_airline}`, (err, res) => {
                if(err){
                    reject(err);
                }
                resolve(res);
    ...
    deleteAirline: (id_airline) => {
        return new Promise((resolve, reject) => {
            db.query(`delete from airline where id_airline=${id_airline}`, (err, res) => {
                if(err){
                    reject(err);
                }
                resolve(res);
